        ...
        <form action="{{ route('laporan.index') }}" method="get" data-toggle="validator" class="form-horizontal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Periode Laporan Dan Filter Produk</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control datepicker"
                                required autofocus autocomplete="off" value="{{ request('tanggal_awal') }}"
                    ...
                    <div class="form-group row">
                        <label for="tanggal_akhir" class="col-lg-2 col-lg-offset-1 control-label">Pilih Produk</label>
                        <div class="col-lg-6">
                            <select class="form-control" name="produk" aria-label="Default select example">
